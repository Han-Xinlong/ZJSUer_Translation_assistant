...
后端默认是 `mock` 模式，不需要配置真实 AI Key，也可以体验翻译、润色、收藏表达、表达改进库、历史详情和学习档案等完整流程。
...
> 当前仓库已完成从 0 到 1 的 MVP：前端工作台、FastAPI 后端、真实模型 Provider、学习记录、表达库、表达改进库、学习档案、演示工具、测试和国内 Docker 部署均已具备初版。
